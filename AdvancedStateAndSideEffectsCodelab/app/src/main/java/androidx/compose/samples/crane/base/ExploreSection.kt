...
fun ExploreSection(
    ...
    Surface(modifier = modifier.fillMaxSize(), color = Color.White, shape = BottomSheetShape) {
        Column(modifier = Modifier.padding(start = 24.dp, top = 20.dp, end = 24.dp)) {
            ...
            // Using this function guarantees that the calculation will only occur
            // whenever one of the states used in the calculation changes.
            ...
            Box(Modifier.weight(1f)) {
                ...
                if (showButton) {
                    ...
                    FloatingActionButton(
                            backgroundColor A= MaterialTheme.colors.primary,
                            modifier = Modifier
